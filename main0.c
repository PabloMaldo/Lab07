 ...
 * Author: pablo
 *
 * Created on April 9, 2023, 11:03 PM
 */
...
void main() {
    ...
    TRISCbits.TRISC2 = 0; // Configuramos el pin RC2 como entrada
    ...
    while (1) {
        ...
        CCPR1L = 188; // Configuramos el valor de duty cycle alto para un ciclo de trabajo del 9%
        __delay_ms(1000); // Esperamos 1 segundo para que el servo se posicione
    }
